      ...
      <div className="HeroBackground bg-cover bg-no-repeat bg-center h-[600px] overflow-hidden">
        <div className="flex justify-center items-center w-full h-full">
          <div className="flex flex-col justify-around">
            ...
            <div className="text-[25px] sm:text-[40px] md:text-[70px] lg:text-[50px] leading-[1.1] font-light mb-4">
              AUTUMN SALE STYLISH
              <br />
          ...
          <img src={heroimg} alt="no image" className="lg:block hidden h-[600px]" />
        </div>
      </div>
    </>
  );
